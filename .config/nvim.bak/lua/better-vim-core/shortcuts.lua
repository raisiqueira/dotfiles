...
local n_defaults = {
  ...
  ["<leader>c"] = { name = "LSP / Highlights", _ = "which_key_ignore" },
  ["<leader>d"] = { name = "Diagnostics", _ = "which_key_ignore" },
  ["<leader>e"] = { name = "Configuration", _ = "which_key_ignore" },
  ["<leader>g"] = { name = "Git / LSP Declarations and Definitions", _ = "which_key_ignore" },
  ["<leader>l"] = { name = "LSP Code Lens", _ = "which_key_ignore" },
  ["<leader>r"] = { name = "LSP Rename", _ = "which_key_ignore" },
  ["<leader>s"] = { name = "Run command", _ = "which_key_ignore" },
  ["<leader>w"] = { name = "LSP Workspace", _ = "which_key_ignore" },
}
